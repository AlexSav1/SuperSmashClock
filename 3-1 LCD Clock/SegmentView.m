...
- (void)drawRect:(CGRect)rect {
    ...
    [self.bezPath addLineToPoint:CGPointMake(width, height - (height/12))];
    
    [self.bezPath addLineToPoint:CGPointMake(width/2, height)];
    [self.bezPath addLineToPoint:CGPointMake(0.0, height - (height/12))];
