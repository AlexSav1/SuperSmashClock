...
#import "SegmentViewH.h"

@implementation SegmentViewH
...
- (void)drawRect:(CGRect)rect {
    ...
    [self.bezPath moveToPoint:CGPointMake(width/12, height/2)];
    [self.bezPath addLineToPoint:CGPointMake(width/6, 0.0)];
    [self.bezPath addLineToPoint:CGPointMake(width - (width/6), 0.0)];
    
    [self.bezPath addLineToPoint:CGPointMake(width - (width/12), height/2)];
    [self.bezPath addLineToPoint:CGPointMake(width - (width/6), height)];
    [self.bezPath addLineToPoint:CGPointMake(width/6, height)];
    
    
    
//    [self.bezPath moveToPoint:CGPointMake(width/2, height/12)];
//    [self.bezPath addLineToPoint:CGPointMake(width, height/6)];
...
//    [self.bezPath addLineToPoint:CGPointMake(0.0, height/6)];
